                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td rowspan="5"><input type="number" class="form-control" value="{{$response->biaya_pemesanan}}"
                                ...
                                <tr class="text-center">
                                    <td><input type="number" class="form-control" value="{{$response->average_penggunaan_tahunan}}"
