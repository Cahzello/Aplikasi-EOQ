...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <a href="/input-data" class="card border-left-primary shadow h-100">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-lg-4 mb-4">
        <a href="#" class="card border-left-success shadow h-100">
            <div class="card-body" style="cursor: pointer;">
                <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-lg-4 mb-4">
        <a href="#" class="card border-left-info shadow h-100">
            <div class="card-body" style="cursor: pointer;">
                <div class="d-flex justify-content-between align-items-center mb-3">
